...
export default class ListaResponsavel extends Component {
  ...
  handleAdd = () => {
    // TODO esse metodo terá que add pela matricula do aluno ou por QRCODE mas não sairá da tela de listagem, somente apresentará um popup para incluir a matricula do aluno.
  };
