...
class Dialog extends React.Component {
  constructor(props) {
    super(props);
    this.state = { inputModal: '', openning: true, value: '' };
  }
  gravarAluno = async mat => {
    try {
      console.log(mat);
      const resp = await api.buscarAluno(mat);

      return resp;
    } catch (err) {
      console.error('ERROR gravarAluno', err);
    }
  };
  ...
  render() {
    ...
    var cancelText = this.props.cancelText || 'Cancelar';
    var submitText = this.props.submitText || 'Gravar';
